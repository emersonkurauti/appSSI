...
namespace appSSI
{
    public class coDefeitoSolucao : csModelBase
    {
        ...
        private string _DescDefeito;

        public string DescDefeito
        {
            get { return _DescDefeito; }
            set { _DescDefeito = value; }
        }
        ...
        private string _pcDescDefeito;

        public string pcDescDefeito
        {
            get { return _pcDescDefeito; }
            set { _pcDescDefeito = value; }
        }

        /// <summary>
        /// Construtor
        /// </summary>
        public coDefeitoSolucao()
        {
            AtualizaObj();
            LimparAtributos();
        }
