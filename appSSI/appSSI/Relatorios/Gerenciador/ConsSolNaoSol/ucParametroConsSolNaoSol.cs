...
namespace appSSI
{
    public partial class ucParametroConsSolNaoSol : KuraFrameWork.Componentes_Visuais.ucParametroRelatorio
    {
        private int cdEmpresa = 0;
        private int cdSistema = 0;
        private int cdModulo = 0;
        private int cdTela = 0;
        private int cdAcao = 0;

        public ucParametroConsSolNaoSol()
        {
            InitializeComponent();
        }
        ...
        private void ucEmpresasCons_AoConsultarRegistro()
        {
            if (ucEmpresasCons.bMudouCodigo)
            {
                ...
                ucSistemasCons.cdEmpresa = Convert.ToInt32(ucEmpresasCons.txtCodigo.Text);
                cdEmpresa = ucSistemasCons.cdEmpresa;
            }
        }
    }
}
